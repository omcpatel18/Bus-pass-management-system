...
For createsuperuser:
- Enter your own admin email and strong password (won't show while typing, that's normal)
...
2. Login with the superuser credentials you created in the previous step
