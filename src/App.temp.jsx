...
function LiveClock() {
  ...
  return (
    <div>
      <div style={{ fontFamily:"var(--font-mono)", fontSize:28, letterSpacing:4,
      ...
      <div style={{ fontFamily:"var(--font-mono)", fontSize:7, letterSpacing:3,
        color:"var(--muted-on-ink)", marginTop:3 }}>{date}</div>
    </div>
  );
}
  ...
  return (
    <div style={{ minHeight:"100vh", background:"var(--cream)", display:"flex" }}>
      ...
      <div style={{ width:"54%", 
        ...
        {ROUTE_LINES.map((line, li) => (
          <div key={li} style={{ position:"absolute", left:`${line.x}%`, top:0, bottom:0, width:4,
            ...
            {STOP_Y.map((sy, si) => {
              ...
              return (
                <div key={si} style={{ position:"absolute", top:`${sy}%`,
            ...
            <div style={{ position:"absolute", top:`${busPos[li]}%`,
              left:"50%", transform:"translate(-50%,-50%)",
        ...
        {/* Dot grid accent */}
        <div style={{ position:"absolute", top:36, right:112, width:80, height:110,
        ...
        <div style={{ position:"relative", zIndex:5 }}>
          ...
          <div style={{ display:"flex", gap:8, marginBottom:18 }}>
            {CITY_ROUTES.map(r => (
              <div key={r.id} style={{ background:r.color, padding:"5px 12px",
                fontFamily:"var(--font-mono)", fontSize:11, letterSpacing:3,
                color:"white", fontWeight:700 }}>{r.code}</div>
            ))}
            <div style={{ background:"rgba(255,255,255,.07)", padding:"5px 12px",
              fontFamily:"var(--font-mono)", fontSize:7, letterSpacing:2,
              color:"var(--muted-on-ink)" }}>+ MORE ROUTES</div>
          </div>
            ...
            {[["12","","ROUTES"],["50","K+","DAILY RIDERS"],["5","","PASS TYPES"],["99","%","UPTIME"]].map(([n,suf,l], idx) => (
              <div key={l} style={{ animation:`fadeUp .5s ease ${300 + idx * 150}ms both` }}>
                ...
                <div style={{ fontFamily:"var(--font-mono)", fontSize:6,
                  color:"var(--muted-on-ink)", letterSpacing:3, marginTop:4 }}>{l}</div>
              </div>
            ))}
          </div>
              ...
              return (
                <div key={r.code} style={{ display:"flex", alignItems:"center", gap:6,
                  ...
                  <span style={{ fontFamily:"var(--font-mono)", fontSize:7, letterSpacing:2,
                    color:r.color, fontWeight:700 }}>{r.code}</span>
                  <span style={{ fontFamily:"var(--font-mono)", fontSize:6, letterSpacing:1,
                    color:"var(--muted-on-ink)" }}>{r.status}</span>
                </div>
              );
            })}
          </div>
      ...
      <div style={{ flex:1, display:"flex", flexDirection:"column",
        ...
        <div style={{ maxWidth:360, animation:"fadeUp .5s ease" }}>
          ...
          <div style={{ marginBottom:28 }}>
            <div style={{ fontFamily:"var(--font-mono)", fontSize:7, letterSpacing:5,
              color:"var(--amber-text)", marginBottom:10 }}>SIGN IN</div>
            <div style={{ fontFamily:"var(--font-serif)", fontSize:40,
              color:"var(--ink)", lineHeight:1.05, marginBottom:2 }}>
              Welcome<br/>back.
            </div>
            {/* Animated underline */}
            <div style={{ height:3, background:"var(--amber)", width:64,
              animation:"lineGrow .6s ease .3s both", transformOrigin:"left" }}/>
          </div>
              ...
              {[["passenger","🚌 PASSENGER"],["admin","⚙ ADMIN"],["conductor","🔍 CONDUCTOR"]].map(([r,l]) => (
                <button key={r} onClick={()=>setRole(r)}
                  style={{ flex:1, padding:"11px 0",
                    ...
                    cursor:"pointer", transition:"background .25s, color .25s, border-bottom .25s" }}>{l}</button>
              ))}
            </div>
          </div>
    ...
    <footer style={{ background:"var(--ink)", borderTop:"3px solid var(--amber)" }}>
      ...
      <div style={{ borderBottom:"1px solid rgba(255,255,255,.06)",
        ...
        <div style={{ display:"flex", gap:0, alignItems:"center", flexWrap:"wrap" }}>
          <div style={{ fontFamily:"var(--font-mono)", fontSize:6, letterSpacing:4,
            color:"var(--muted-on-ink)", marginRight:20, flexShrink:0 }}>LIVE STATUS</div>
          {routeStatuses.map((r,i) => (
            <div key={r.code} style={{ display:"flex", alignItems:"center", gap:8,
              ...
              <span style={{ fontFamily:"var(--font-mono)", fontSize:7, letterSpacing:2,
                color:"var(--cream-on-ink)", fontWeight:700 }}>{r.code}</span>
              <span style={{ fontFamily:"var(--font-mono)", fontSize:7, letterSpacing:1,
                color: r.delay>0 ? "#F0A830" : "#52B788" }}>{r.status}</span>
            </div>
          ))}
          ...
          <div style={{ marginLeft:"auto", display:"flex", alignItems:"center", gap:8, flexShrink:0 }}>
            ...
            <span style={{ fontFamily:"var(--font-mono)", fontSize:9, letterSpacing:4,
              color:"var(--amber-on-ink)" }}>{hh}:{mm}</span>
            <span style={{ fontFamily:"var(--font-mono)", fontSize:6, letterSpacing:3,
      ...
      <div style={{ maxWidth:1200, margin:"0 auto", padding:"40px 44px 32px",
        ...
        <div>
          ...
          <div>
            <div style={{ fontFamily:"var(--font-mono)", fontSize:6, letterSpacing:4,
              color:"var(--muted-on-ink)", marginBottom:8 }}>GET TRANSIT ALERTS</div>
          ...
          {CITY_ROUTES.map(r => (
            <div key={r.id} style={{ marginBottom:14 }}>
              <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:3 }}>
                ...
                <span style={{ fontFamily:"var(--font-display)", fontSize:14, letterSpacing:2,
                  color:"var(--cream-on-ink)" }}>{r.name.toUpperCase()}</span>
              </div>
        ...
        <div>
          ...
          {PASS_DURATIONS.map(d => (
            <div key={d.id} style={{ display:"flex", justifyContent:"space-between",
              ...
              <div>
                <div style={{ fontFamily:"var(--font-display)", fontSize:13, letterSpacing:2,
                  color:"var(--cream-on-ink)" }}>{d.label}</div>
                <div style={{ fontFamily:"var(--font-mono)", fontSize:6, letterSpacing:1,
                  color:"var(--muted-on-ink)" }}>{d.desc}</div>
              </div>
              {d.disc > 0 && (
                <div style={{ fontFamily:"var(--font-mono)", fontSize:8, letterSpacing:1,
                  color:"var(--green-on-ink)", background:"rgba(82,183,136,.12)",
                  padding:"2px 7px" }}>-{d.disc}%</div>
              )}
            </div>
          ))}
        </div>
            ...
            <div key={p.id} style={{ display:"flex", alignItems:"center", gap:10,
              ...
              <div>
                <div style={{ fontFamily:"var(--font-display)", fontSize:13, letterSpacing:1,
                  color:"var(--cream-on-ink)" }}>{p.label}</div>
                <div style={{ fontFamily:"var(--font-mono)", fontSize:6, letterSpacing:1,
                  color:"var(--green-on-ink)" }}>{p.disc}% OFF</div>
              </div>
            </div>
          ))}
        </div>
          ...
          {[
            ...
            <div key={name} style={{ marginBottom:10 }}>
              <div style={{ fontFamily:"var(--font-sans)", fontSize:11,
                color:"var(--cream-on-ink)", fontWeight:500 }}>{name}</div>
              <div style={{ fontFamily:"var(--font-mono)", fontSize:6, letterSpacing:1,
                color:"var(--muted-on-ink)" }}>{sub}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div style={{ borderTop:"1px solid rgba(255,255,255,.06)",
        ...
        <div style={{ display:"flex", gap:16 }}>
          {["TERMS","PRIVACY","SUPPORT","ACCESSIBILITY","CONTACT"].map(l => (
            <span key={l} style={{ fontFamily:"var(--font-mono)", fontSize:6, letterSpacing:2,
...
export default function App() {
  ...
  const renderPage=()=>{
    if(auth.role==="admin"&&page==="admin") return <AdminApplications/>;
