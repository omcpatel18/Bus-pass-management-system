...
function QRTicket({ ticket, onClose, showClose = true }) {
  ...
  return (
    <div style={{
      ...
      {/* ── Colour band ── */}
      <div style={{
        background: bus.lineColor, padding: "10px 22px",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{
            ...
            color: "white", background: "rgba(0,0,0,.2)", padding: "3px 10px"
          }}>BUSPASSPRO</div>
          {showClose && (
        ...
        <div style={{
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{
              ...
              color: "var(--ink)"
            }}>{ticket.date} · {ticket.time}</div>
          </div>
        </div>

        {/* Route banner — dark ink block */}
        <div style={{
          background: "var(--ink)", margin: "0 -22px",
          padding: "16px 22px",
          ...
          <div>
            <div style={{
              ...
              color: "var(--muted-on-ink)", marginBottom: 4
            }}>◉ FROM</div>
            <div style={{
              fontFamily: "var(--font-display)", fontSize: 20, letterSpacing: 1,
              color: "var(--cream-on-ink)", lineHeight: 1.1
            }}>{ticket.from}</div>
          </div>
          <div style={{
            textAlign: "center", color: "var(--amber-on-ink)",
          ...
          <div style={{ display: "flex", gap: 20 }}>
            {[["FARE", `₹${ticket.fare}`], ["DISTANCE", `~${ticket.km} km`]].map(([l, v]) => (
              <div key={l}>
                ...
                <div style={{
                  fontFamily: "var(--font-display)", fontSize: 22, letterSpacing: 1,
                  color: "var(--ink)", lineHeight: 1
                }}>{v}</div>
              </div>
            ))}
      ...
      <div style={{
        ...
        <div style={{
          position: "absolute", left: -14, width: 28, height: 28, borderRadius: "50%",
        ...
        <div style={{
          position: "absolute", right: -14, width: 28, height: 28, borderRadius: "50%",
          background: "var(--cream)", border: "2px solid var(--ink)", zIndex: 2
        }} />
      </div>
      ...
      {/* ── QR section ── */}
      <div style={{
        padding: "16px 22px 22px", display: "flex", gap: 20, alignItems: "flex-start",
        ...
        <div style={{ flexShrink: 0, textAlign: "center" }}>
          ...
          <div style={{
            width: 120, height: 120, border: "2px solid var(--ink)",
        ...
        <div style={{ flex: 1 }}>
          ...
          {[
            ...
            <div key={i} style={{ display: "flex", gap: 6, marginBottom: 5 }}>
              <span style={{
                ...
                color: "var(--amber-text)", flexShrink: 0, lineHeight: 1.4
              }}>{i + 1}.</span>
              <span style={{
          ...
          <div style={{
            ...
            <span style={{
              fontFamily: "var(--font-display)", fontSize: 12, letterSpacing: 3,
      ...
      {isValid && (
        <div style={{
          ...
          <div style={{
            ...
            letterSpacing: 4, color: "var(--green)", opacity: .65
          }}>VALID</div>
        </div>
      )}
      {isCancelled && (
        <div style={{
          ...
          <div style={{
            fontFamily: "var(--font-display)", fontSize: 22,
            letterSpacing: 4, color: "var(--red)", opacity: .65
          }}>VOID</div>
        </div>
      )}
    </div>
...
function ScanModal({ ticket, onClose }) {
  ...
  return (
    <div style={{
      position: "fixed", inset: 0, background: "rgba(26,18,8,.78)",
      display: "flex", alignItems: "center", justifyContent: "center",
      zIndex: 3000, animation: "fadeIn .2s ease"
    }} onClick={onClose}>
      <div style={{
        width: 380, background: "var(--ink)", border: "2px solid var(--amber)",
        ...
        <div style={{
          ...
          <div>
            <div style={{
              fontFamily: "var(--font-mono)", fontSize: 7, letterSpacing: 4,
              color: "var(--muted-on-ink)", marginBottom: 2
            }}>CONDUCTOR TERMINAL</div>
            <div style={{
        ...
        <div style={{ padding: "24px 20px" }}>
          {scanning ? (
            <div style={{ textAlign: "center", padding: "32px 0" }}>
              <div style={{
                width: 48, height: 48, border: "3px solid rgba(240,168,48,.2)",
                borderTop: "3px solid var(--amber-on-ink)", borderRadius: "50%",
                animation: "spin .7s linear infinite", margin: "0 auto 16px"
              }} />
              <div style={{
                fontFamily: "var(--font-display)", fontSize: 18, letterSpacing: 3,
                color: "var(--amber-on-ink)"
              }}>SCANNING…</div>
              <div style={{
                fontFamily: "var(--font-mono)", fontSize: 8, letterSpacing: 2,
                color: "var(--muted-on-ink)", marginTop: 6
              }}>VERIFYING TICKET DATA</div>
            </div>
          ) : (
...
const Btn = ({ children, onClick, variant = "primary", size = "md", full = false, disabled = false }) => {
  ...
  return <button onClick={onClick} disabled={disabled}
    ...
    style={{
      padding: pad, background: s.bg, color: s.c, border: s.b || "none",
...
const Spinner = ({ size = 18, color = "var(--amber)" }) => (
  <div style={{
    width: size, height: size, border: `2px solid rgba(200,131,42,.25)`,
    ...
    <div ref={wrapRef} style={{ position: "relative", width: "100%", zIndex: open ? 50 : 1 }}>
      ...
      {open && (
        <div style={{
          ...
          <div style={{
            padding: "7px 14px 5px", borderBottom: "1px solid var(--rule)",
            display: "flex", justifyContent: "space-between", alignItems: "center"
          }}>
          ...
          {filtered.length === 0 && (
            <div style={{
              padding: "16px 14px", fontFamily: "var(--font-serif)",
              fontSize: 13, color: "var(--muted)", fontStyle: "italic"
            }}>No stops match "{query}"</div>
          )}
          {filtered.map((stop, i) => (
            <div key={stop}
...
export default function TicketBooking({ onNavigate }) {
  ...
  return (
    <>
      ...
      {/* ── Page header ── */}
      <div style={{
        borderBottom: "3px solid var(--ink)", paddingBottom: 20, marginBottom: 28,
        ...
        <div style={{ animation: "fadeIn .3s ease" }}>
          ...
          {step === 1 && (
            <div style={{
              ...
              <div>
                <div style={{
                  border: "1.5px solid var(--ink)", borderRadius: "var(--r-xl)", background: "var(--surface)",
                  marginBottom: 14
                }}>
                ...
                {pickup && dest && (
                  <div style={{
                    border: "1.5px solid var(--amber)", borderRadius: "var(--r-sm)", background: "var(--warn-bg)",
                    ...
                    <div>
                      <div style={{
                        fontFamily: "var(--font-mono)", fontSize: 7, letterSpacing: 4,
                        color: "var(--amber-text)", marginBottom: 2
                      }}>ESTIMATED FARE</div>
                      <div style={{
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  {BUS_TYPES.map((bt, i) => (
                    <div key={bt.id} onClick={() => setBusType(bt.id)}
                      style={{
                        border: `2px solid ${busType === bt.id ? "var(--ink)" : "var(--rule)"}`,
          ...
          {step === 2 && (
            <div style={{
              ...
              {/* Receipt */}
              <div style={{
                border: "2px solid var(--ink)", borderRadius: "var(--r-xl)", overflow: "hidden", background: "var(--surface)",
                ...
                <div style={{ padding: "20px 22px", borderBottom: "1px solid var(--rule)" }}>
                  <div style={{
                    ...
                    <div style={{
                      background: "var(--success-bg)", border: "1px solid var(--green)",
                      padding: "10px 14px"
                    }}>
                      <div style={{
                        fontFamily: "var(--font-mono)", fontSize: 7, letterSpacing: 3,
                  ...
                  <div style={{
                    ...
                    <div>
                      ...
                      <div style={{
                        fontFamily: "var(--font-sans)", fontSize: 11,
                        color: "var(--muted)"
                      }}>{bus.desc} · ~{dist} km · {bus.cap} seats</div>
                    </div>
                  </div>
                </div>
                ...
                <div style={{ padding: "20px 22px", borderBottom: "1px solid var(--rule)" }}>
                  ...
                  <div style={{
                    ...
                    <span style={{
                      ...
                      letterSpacing: 1, color: "var(--amber-text)"
                    }}>₹{fare + 4.5}</span>
                  </div>
                </div>
              ...
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 6, marginBottom: 20 }}>
                  {PAYMENT_METHODS.map(p => (
                    <div key={p.id} onClick={() => setPayment(p.id)}
                      style={{
                        border: `1.5px solid ${payment === p.id ? "var(--ink)" : "var(--rule)"}`,
                ...
                <div style={{
                  border: "1.5px solid var(--rule)", padding: "16px",
              ...
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div>
                    ...
                    }}>TICKET ISSUED SUCCESSFULLY</div>
                    <div style={{
            ...
            <>
              ...
              return (
                <div key={tkt.id} style={{
                  border: `1.5px solid ${isV ? "var(--green)" : isC ? "var(--red)" : "var(--rule)"}`,
                  ...
                  <div style={{
                    width: 48, height: 48, background: b.lineColor,
                    display: "flex", alignItems: "center", justifyContent: "center",
                  ...
                  <div style={{
                    ...
                    <div style={{ display: "flex", gap: 6 }}>
                      <button onClick={() => setViewTicket(tkt)}
                        style={{
                          padding: "5px 12px", background: "var(--ink)", border: "none",
                          fontFamily: "var(--font-mono)", fontSize: 7, letterSpacing: 2,
                          color: "var(--amber-on-ink)", cursor: "pointer"
                        }}>VIEW QR</button>
                      {!isC && (
      ...
      {tab === "nearby" && (
        <div style={{ animation: "fadeIn .3s ease" }}>
          <div style={{ border: "2px solid var(--ink)", background: "var(--surface)" }}>
            ...
            <div style={{
              height: 380, background: "var(--parchment)", position: "relative",
              overflow: "hidden", borderBottom: "1px solid var(--rule)"
            }}>
              {[...Array(10)].map((_, i) => (
                <div key={`v${i}`} style={{
                  position: "absolute", left: `${(i + 1) * 10}%`,
              ...
              {NEARBY_BUSES.map(b => {
                ...
                return (
                  <div key={b.id} style={{
                    ...
                    <div style={{
                      position: "absolute", inset: -6, background: bt.lineColor,
            ...
            <div style={{
              ...
              {[
                ...
                <div key={l} style={{
                  ...
                  <div style={{
                    fontFamily: "var(--font-display)", fontSize: 22,
                    letterSpacing: 1, color: c, lineHeight: 1
                  }}>{v}</div>
                </div>
              ))}
            </div>
      ...
      {viewTicket && (
        <div style={{
          position: "fixed", inset: 0, background: "rgba(26,18,8,.72)",
          display: "flex", alignItems: "center", justifyContent: "center",
          ...
          <div style={{
            ...
            {viewTicket.status !== "CANCELLED" && (
              <button onClick={() => { setViewTicket(null); setScanTicket(viewTicket); }}
                style={{
                  width: "100%", padding: "12px 0", background: "var(--amber)", border: "none",
                  fontFamily: "var(--font-display)", fontSize: 14, letterSpacing: 3,
                  color: "var(--ink)", cursor: "pointer"
                }}>
                🔍 SIMULATE CONDUCTOR SCAN
